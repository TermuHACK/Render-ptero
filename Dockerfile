...
COPY --from=gotty-builder /gotty /usr/local/bin/gotty COPY --from=pterovm-builder /pterovm /home/Dvdr00/pterovm
...
rm panel.tar.gz RUN chown -R Dvdr00:Dvdr00 /var/www/pterodactyl && 
...
USER Dvdr00 WORKDIR /home/Dvdr00
